...
export const navigation: NavItem[] = [
  { label: "Home", href: "/" },
  {
    ...
    children: [
      ...
      { label: "About Our Doctor", href: "/about/doctor" },
      { label: "Why Geriatric Medicine?", href: "/about/why-geriatric-medicine" },
    ],
  },
  {
    label: "Services",
    href: "/services",
    children: [
      { label: "Comprehensive Geriatric Assessment", href: "/services/comprehensive-geriatric-assessment" },
      { label: "Memory & Cognitive Disorders", href: "/services/memory-cognitive-disorders" },
      { label: "Medication Review & Optimization", href: "/services/medication-review" },
      { label: "Falls, Frailty & Mobility", href: "/services/falls-frailty-mobility" },
      { label: "Chronic Disease Management", href: "/services/chronic-disease-management" },
      { label: "Geriatric Rehabilitation", href: "/services/geriatric-rehabilitation" },
      { label: "Caregiver Training", href: "/services/caregiver-training" },
      { label: "Home-based Care", href: "/services/home-based-care" },
    ],
  },
  {
    label: "Care of the Older Person",
    href: "/care",
    children: [
      { label: "Dementia", href: "/care/dementia" },
      { label: "Geriatric Syndromes", href: "/care/geriatric-syndromes" },
      { label: "Healthy Aging", href: "/care/healthy-aging" },
      { label: "Nutritional Needs", href: "/care/nutritional-needs" },
      { label: "Osteoporosis", href: "/care/osteoporosis" },
      { label: "Successful Aging", href: "/care/successful-aging" },
    ],
  },
...
export const footerColumns: FooterColumn[] = [
  ...
  },
  {
    title: "Our Services",
    links: [
      { label: "Geriatric Assessment", href: "/services/comprehensive-geriatric-assessment" },
      { label: "Memory & Cognition", href: "/services/memory-cognitive-disorders" },
      { label: "Medication Review", href: "/services/medication-review" },
      { label: "Falls & Mobility", href: "/services/falls-frailty-mobility" },
      { label: "Chronic Disease", href: "/services/chronic-disease-management" },
    ],
  },
  {
    title: "Legal",
